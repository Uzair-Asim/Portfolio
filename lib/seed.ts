...
const seedData = {
  ...
  achievements: [
    { icon: '🤖', text: 'Automated Shopify order handling, eliminating manual processing entirely and boosting efficiency by 80–90%.' },
    { icon: '⚡', text: 'Improved database performance by 40% through systematic query optimization.' },
    { icon: '🧠', text: 'Developed an AI assistant using the Gemini API and Microsoft Copilot for smarter user interaction.' },
    { icon: '⚖️', text: 'Implemented a Round Robin algorithm to evenly distribute 300+ lab launches weekly.' },
